...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isRemote Peltic SupportIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isRemote Peltic SupportIdd) {
    final virtualDisplays = ffi.ffiModel.pi.Remote Peltic SupportVirtualDisplays;
